...
interface IClearinghouse is IClearinghouseState, IClearinghouseEventEmitter, IEndpointGated, IVersion {
    ...
    function claimSequencerFees(IEndpoint.ClaimSequencerFees calldata tx, int128[] calldata fees) external;
    ...
    function getHealth(bytes32 subaccount, IProductEngine.HealthType healthType) external view returns (int128);
