...
contract FixVertexManager1 is Initializable, UUPSUpgradeable, OwnableUpgradeable, ReentrancyGuard {
    ...
    function patch() external onlyOwner {
        ...
        IERC20Metadata ETH = IERC20Metadata(0x82aF49447D8a07e3bd95BD0d56f35241523fBab1);
        IERC20Metadata ARB = IERC20Metadata(0x912CE59144191C1204E64559FE8253a0e49E6548);
